import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c as r,b as e,d as i,a as d,e as n}from"./app-6018dc01.js";const c={},v=n('<h1 id="git" tabindex="-1"><a class="header-anchor" href="#git" aria-hidden="true">#</a> Git</h1><h2 id="第01章-简介" tabindex="-1"><a class="header-anchor" href="#第01章-简介" aria-hidden="true">#</a> 第01章 简介</h2><p>Git是一个免费的，开源的<strong>分布式</strong>版本控制系统，可以快速高效地处理从小型到大型的各种项目。创始人为Linux创始人Linux Torvalds。又称为版本控制是一种记录文件内容变化，以便将来查阅特定版本修订情况的系统。</p><h2 id="第02章-官网" tabindex="-1"><a class="header-anchor" href="#第02章-官网" aria-hidden="true">#</a> 第02章 官网</h2>',4),u={href:"https://git-scm.com/",target:"_blank",rel:"noopener noreferrer"},o=e("h2",{id:"第03章-下载",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#第03章-下载","aria-hidden":"true"},"#"),i(" 第03章 下载")],-1),m={href:"https://git-scm.com/",target:"_blank",rel:"noopener noreferrer"},g=n(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>下载完后一直下一步不建议修改安装目录，安装的目录路径不要有中文</strong></b></p></div><h2 id="第04章-作用" tabindex="-1"><a class="header-anchor" href="#第04章-作用" aria-hidden="true">#</a> 第04章 作用</h2><p>可以记录文件修改历史记录，从而让用户能够查看历史版本，方便版本切换。能让个人开发过度到团队协作。</p><h2 id="第05章-命令" tabindex="-1"><a class="header-anchor" href="#第05章-命令" aria-hidden="true">#</a> 第05章 命令</h2><p>下载完成后在某一文件夹下鼠标右键选择Open <strong>Git Bash</strong> Here会打开一个黑窗口，此窗口相当于一个小型的<strong>Linux环境</strong>，能输入Linux命令。</p><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>第一次使用前必须要设置用户签名和邮箱，因为是多人环境，设置用户名和邮箱是为了方便区分。</strong></b></p></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>提交的文件中单个文件不能超过100MB不然推送不上去</strong></b></p></div><h3 id="git相关" tabindex="-1"><a class="header-anchor" href="#git相关" aria-hidden="true">#</a> Git相关</h3><div class="hint-container tip"><p class="hint-container-title">小贴士</p><p><b style="color:#A6522C;"> 以下命令中用[ ]括起来的内容表示自定义。如git add [FileName]表示FileName为自定义内容。可以为a.txt，也可为b.txt。</b></p></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git --version
// 作用：查看当前git版本
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,11),b=n(`<hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git init
// 作用：会在当前文件夹下创建本地仓库即 .git 文件
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,3),h=e("hr",null,null,-1),x=e("hr",null,null,-1),p=n(`<hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git status
// 作用：查看暂存区与非暂存区有哪些文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,33),_=n(`<hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 拉取代码
...
// 作用：清除当前所有文字
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第06章-tortoisegit" tabindex="-1"><a class="header-anchor" href="#第06章-tortoisegit" aria-hidden="true">#</a> 第06章 TortoiseGit</h2><p><b style="color:#3e547d;"><strong>图形化工具使用</strong></b></p><p>安装图形化管理工具TortoiseGit</p><p><b style="color:#3e547d;"><strong>下载地址</strong></b></p>`,17),f={href:"https://tortoisegit.org/download/",target:"_blank",rel:"noopener noreferrer"};function N(B,G){const a=t("ExternalLinkIcon");return l(),r("div",null,[v,e("p",null,[e("a",u,[i("Git官网"),d(a)])]),o,e("p",null,[e("a",m,[i("Git下载"),d(a)])]),g,i(" ```text // 命令：git config --global user.name [username] // 命令：git config --global user.email [email] // 作用：通常在第一次时候使用，设置git的用户名和邮箱，每次提交代码时可以知道是谁提交的。方便多人协作开发时管理。 ``` "),b,i(" ```text 可以指定当前文件夹下的哪些文件交给Git管理。当前文件下的所有文件叫工作区，交给Git管理的文件叫暂存区。 // 命令：git add [FileName] // 作用：指定文件到暂存区即指定当前文件夹下的哪些文件交给Git管理。FileName是文件的名字，如user.txt。 // 扩展命令：git add . // 作用：把当前文件夹下的所有文件都上传到暂存区即都交给Git管理。 ``` "),h,i(" ```text // 命令：git rm --cached [FileName] // 作用：把文件名为FileName的从暂存区删除 ``` "),x,i(' ```text // 命令：git commit -m "[版本说明文字]" // 作用：将暂存区的所有文件提交到本地仓库也就是.git文件里，形成一次提交记录。"版本说明文字"是对这次版本的描述。可以自定义。 ``` '),p,i(" ```text // 克隆代码 // 命令：git clone [url] // 作用：从远程仓库克隆代码到本地，在哪里打开的git bash，会在打开git bash文件路径下创建一个文件夹并将克隆下来的代码放到此文件夹中。文件夹名字为url中最后一个/之后.git之前的符号。 // 命令：git clone [url] [FileName] // 作用：从远程仓库克隆代码到本地，在哪里打开的git bash，会在打开git bash文件路径下创建一个文件夹并将克隆下来的代码放到此文件夹中。文件夹名字为自定义的FileName。 ``` "),_,e("p",null,[e("a",f,[i("TortoiseGit"),d(a)])])])}const F=s(c,[["render",N],["__file","Git.html.vue"]]);export{F as default};
