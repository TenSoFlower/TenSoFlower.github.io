...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git commit -m &quot;[版本说明文字]&quot; 
...
// 作用：简化提交历史信息的显示
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 设置别名
...
// 作用：清除当前所有文字
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><hr>`,39),m=e("thead",null,[e("tr",null,[e("th",null,"命令"),e("th",null,"作用")])],-1),b=e("tr",null,[e("td",null,"git --version"),e("td",null,"查看Git版本")],-1),p=e("tr",null,[e("td",null,"git init"),e("td",null,"会在当前文件夹下创建本地仓库即 .git 文件")],-1),x=e("tr",null,[e("td",null,"git status"),e("td",null,"查看本地库状态")],-1),_={href:"http://user.name",target:"_blank",rel:"noopener noreferrer"},f=e("td",null,"设置用户签名",-1),G=e("tr",null,[e("td",null,"git config --global user.email 邮箱"),e("td",null,"设置邮箱")],-1),y=e("tr",null,[e("td",null,"git add 文件名"),e("td",null,"把文件增加到暂存区(把文件增加到Git上)")],-1),N=e("tr",null,[e("td",null,"git rm --cached 文件名"),e("td",null,"把文件从暂存区删除")],-1),k=e("tr",null,[e("td",null,'git commit -m "版本说明文字" 文件名'),e("td",null,"把暂存区的文件提交到本地仓库")],-1),B=e("tr",null,[e("td",null,"git reflog"),e("td",null,"查看版本信息")],-1),I=e("tr",null,[e("td",null,"git log"),e("td",null,"查看版本详细信息")],-1),L=e("h2",{id:"使用",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#使用","aria-hidden":"true"},"#"),t(" 使用")],-1),q=e("p",null,[e("b",{style:{color:"#3e547d"}},[e("strong",null,"图形化工具使用")])],-1),F=e("p",null,"安装图形化管理工具TortoiseGit",-1),D=e("p",null,[e("b",{style:{color:"#3e547d"}},[e("strong",null,"下载地址")])],-1),w={href:"https://tortoisegit.org/download/",target:"_blank",rel:"noopener noreferrer"},T=d('<p><b style="color:#3e547d;"><strong>使用命令行</strong></b></p><table><thead><tr><th>命令</th><th>作用</th></tr></thead><tbody><tr><td>git init</td><td>初始化仓库</td></tr><tr><td>git add *</td><td>增加所有文件到暂存区</td></tr><tr><td>git commit -m &quot;描述信息......&quot;</td><td>提交并提供版本描述信息</td></tr><tr><td>git branch -M 分支名</td><td>自定义分支名</td></tr><tr><td>git remote add origin 远程地址</td><td>设置远程地址</td></tr><tr><td>git push -u origin 分支名</td><td>推送到远程</td></tr><tr><td>git push -f origin 分支名</td><td>使用强覆盖的方式用本地代码替代Git仓库内容</td></tr></tbody></table><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>提交的文件中单个文件不能超过100MB不然推送不上去</strong></b></p></div>',3);function V(E,M){const i=a("ExternalLinkIcon");return s(),r("div",null,[o,e("p",null,[e("a",u,[t("Git官网"),n(i)])]),v,e("p",null,[e("a",g,[t("Git官网"),n(i)])]),h,e("table",null,[m,e("tbody",null,[b,p,x,e("tr",null,[e("td",null,[t("git config --global "),e("a",_,[t("user.name"),n(i)]),t(" 用户名")]),f]),G,y,N,k,B,I])]),L,q,F,D,e("p",null,[e("a",w,[t("TortoiseGit"),n(i)])]),T])}const H=l(c,[["render",V],["__file","Git.html.vue"]]);export{H as default};
