import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,e as a}from"./app-a35d01d1.js";const s="/assets/image-1696389745094-839fb5d8.png",i="/assets/image-1696389745216-1eb63259.png",l="/assets/image-1696389744894-95f3c5b8.png",d="/assets/image-1696389745032-10ba16d7.png",r="/assets/image-1696389745037-a45f29ae.png",o={},u=a(`<h1 id="html" tabindex="-1"><a class="header-anchor" href="#html" aria-hidden="true">#</a> HTML</h1><h2 id="html-1" tabindex="-1"><a class="header-anchor" href="#html-1" aria-hidden="true">#</a> HTML</h2><p>HTML指的是<strong>超文本标记语言</strong>(Hyper Text Markup Language)，它是用来<strong>描述网页</strong>的一种语言。其不是一种编程语言，而是一种<strong>标记语言</strong>(Markup Language)。标记语言是一套<strong>标记标签(<strong>Markup tag)。<strong>超文本</strong>是因为其可以加入图片、声音、动画等内容</strong>超越了文本的限制</strong>，另外还可以从一个文件跳转到另一个文件，与世界各地主机的文件连接(<strong>超级链接文本</strong>)。</p><h2 id="浏览器" tabindex="-1"><a class="header-anchor" href="#浏览器" aria-hidden="true">#</a> 浏览器</h2><p>浏览器是网页显示、运行的平台。相当于将HTML文件<strong>解析</strong>成页面。不同的浏览器有着不同的内核，所以不同的浏览器解析同一份HTML文件也不尽相同。常用的<strong>五大浏览器IE、火狐(Firefox)、谷歌(Chrome)、Safari(苹果)和Opera</strong>。</p><h4 style="text-align:center;">浏览器内核表</h4><table><thead><tr><th>浏览器</th><th>内核</th><th>备注</th></tr></thead><tbody><tr><td>IE</td><td>Trident</td><td>IE、猎豹安全、360极速浏览器、百度浏览器</td></tr><tr><td>Firefox</td><td>Gecko</td><td>火狐浏览器</td></tr><tr><td>Safari</td><td>WebKit</td><td>苹果浏览器</td></tr><tr><td>Chrome/Opera</td><td>Blink</td><td>Chrome/Opera浏览器内核Blink其实是WebKit的分支</td></tr></tbody></table><p>目前<strong>国内浏览器</strong>一般都会采用WebKit/Blink内核，如360、UC、QQ、搜狗等</p><h2 id="web标准" tabindex="-1"><a class="header-anchor" href="#web标准" aria-hidden="true">#</a> Web标准</h2><p>Web标准是由W3C组织和其他标准化组织制定的一系列标准的集合。<strong>W3C(万维网联盟)<strong>是国际最著名的</strong>标准化组织</strong>。制定标准是为了让不同的浏览器显示同一份网页时的排版一样。Web标准主要包括<strong>结构(Structure)、表现(Presentation)、行为(Behavior)。结构由HTML控制、表现由CSS控制、行为由JavaScript控制</strong>。</p><h2 id="网页" tabindex="-1"><a class="header-anchor" href="#网页" aria-hidden="true">#</a> 网页</h2><p>网页是<strong>网站</strong>中的一页，通常是HTML格式的文件，它要通过浏览器来阅读。网页是构成网站的基本元素，通常由<strong>图片</strong>、<strong>链接</strong>、<strong>文字</strong>、<strong>声音</strong>、<strong>视频</strong>等元素组成。网页以.HTML后缀结尾，俗称HTML文件。</p><h2 id="html骨架" tabindex="-1"><a class="header-anchor" href="#html骨架" aria-hidden="true">#</a> HTML骨架</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span> 
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span><span class="token punctuation">&gt;</span></span>
	...
	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">&gt;</span></span>
		...
		<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">&gt;</span></span> //网页标题
	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">&gt;</span></span>
	...
	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 style="text-align:center;">HTML骨架说明</h4><table><thead><tr><th>标签</th><th>说明</th><th>扩展</th></tr></thead><tbody><tr><td><code>&lt;!DOCTYPE html&gt;</code></td><td>DOCTYPE文档类型声明标签 html表示是HTML5版本</td><td></td></tr><tr><td><code>&lt;html lang=&#39;zh-CN&#39;&gt;</code></td><td>属性<strong>lang</strong>表示语言其值是<strong>zh-CN</strong>时表示是一个中文网页，是<strong>en</strong>时表示是一个英文网页</td><td><strong>fr</strong>表示法文等等，更多语言请自行百度😄</td></tr><tr><td><code>&lt;meta charset=&quot;UTF-8&quot;&gt;</code></td><td>属性<strong>charset</strong>来规定HTML文档使用的字符编码</td><td>常用值有GB2312(简体中文)、BIG5(繁体中文)、GBK(简体中文+繁体中文)、UTF-8其中<strong>UTF-8</strong>也被称为<strong>万国码</strong>，基本包含了全世界所有国家需要用到的字符。</td></tr></tbody></table><div class="hint-container info"><p class="hint-container-title">名词解释 属性</p><p>HTML 标签属性是用于在 HTML 元素中提供附加信息的特性。属性通常在标签的开头部分即开始标签中定义，<strong>由键值对组成</strong>。属性的作用是修改或定义标签的行为和显示方式即值不同标签的行为或者显示方式不同。</p></div><h2 id="标签" tabindex="-1"><a class="header-anchor" href="#标签" aria-hidden="true">#</a> 标签</h2><h3 id="标题标签" tabindex="-1"><a class="header-anchor" href="#标题标签" aria-hidden="true">#</a> 标题标签</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">&gt;</span></span>我是一级标题<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;">标题标签独占一行</b></p></div><h3 id="段落标签" tabindex="-1"><a class="header-anchor" href="#段落标签" aria-hidden="true">#</a> 段落标签</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">&gt;</span></span>我是一个段落标签<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="换行标签" tabindex="-1"><a class="header-anchor" href="#换行标签" aria-hidden="true">#</a> 换行标签</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span><span class="token punctuation">/&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="文本格式化标签" tabindex="-1"><a class="header-anchor" href="#文本格式化标签" aria-hidden="true">#</a> 文本格式化标签</h3><table><thead><tr><th>语义</th><th>标签</th><th>说明</th></tr></thead><tbody><tr><td>加粗</td><td><code>&lt;strong&gt;粗体&lt;/strong&gt;或者&lt;b&gt;粗体&lt;/b&gt;</code></td><td>推荐使用<code>&lt;strong&gt;</code>标签加粗</td></tr><tr><td>倾斜</td><td><code>&lt;em&gt;倾斜&lt;/em&gt;或者&lt;i&gt;倾斜&lt;/i&gt;</code></td><td>推荐使用<code>&lt;em&gt;</code>标签加粗</td></tr><tr><td>删除线</td><td><code>&lt;del&gt;删除线&lt;/del&gt;或者&lt;s&gt;删除线&lt;/s&gt;</code></td><td>推荐使用<code>&lt;del&gt;</code>标签加粗</td></tr><tr><td>下划线</td><td><code>&lt;ins&gt;下划线&lt;/ins&gt;或者&lt;u&gt;下划线&lt;/u&gt;</code></td><td>推荐使用<code>&lt;ins&gt;</code>标签加粗</td></tr></tbody></table><h3 id="div标签和span标签" tabindex="-1"><a class="header-anchor" href="#div标签和span标签" aria-hidden="true">#</a> Div标签和Span标签</h3><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;">div独占一行</b></p></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div&gt;我是一个div标签一个人单独占一行&lt;/div&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;">span一行可以放多个</b></p></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;span&gt;百度&lt;/span&gt;
&lt;span&gt;搜狐&lt;/span&gt;
&lt;span&gt;新浪&lt;/span&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="特殊符号" tabindex="-1"><a class="header-anchor" href="#特殊符号" aria-hidden="true">#</a> 特殊符号</h2><table><thead><tr><th>&lt;</th><th>&lt;</th><th>小于号或显示标记</th></tr></thead><tbody><tr><td>&gt;</td><td>&gt;</td><td>大于号或显示标记</td></tr><tr><td>&amp;</td><td>&amp;</td><td>可用于显示其它特殊字符</td></tr><tr><td>&quot;</td><td>&quot;</td><td>引号</td></tr><tr><td>®</td><td>®</td><td>已注册</td></tr><tr><td>©</td><td>©</td><td>版权</td></tr><tr><td>™</td><td>™</td><td>商标</td></tr><tr><td></td><td> </td><td>半个空白位</td></tr><tr><td></td><td>&amp;emsp</td><td>一个空白位</td></tr><tr><td></td><td> </td><td>不断行的空白</td></tr></tbody></table><h2 id="目录-路径" tabindex="-1"><a class="header-anchor" href="#目录-路径" aria-hidden="true">#</a> 目录&amp;路径</h2><p>目录文件夹：就是普通文件夹，里面存放了我们做页面所需要的相关素材比如html文件，图片等。</p><p>根目录：打开目录文件夹的第一层就是根目录</p><p>相对路径</p><figure><img src="`+s+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>绝对路径</p><p>指目录下的绝对位置，通常从盘符开始的路径或完整的网络地址</p><h2 id="标签-1" tabindex="-1"><a class="header-anchor" href="#标签-1" aria-hidden="true">#</a> 标签</h2><h3 id="div标签和span标签-1" tabindex="-1"><a class="header-anchor" href="#div标签和span标签-1" aria-hidden="true">#</a> Div标签和Span标签</h3><p>一行只能放一个Div标签</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div&gt;我是一个div标签一个人单独占一行&lt;/div&gt;
...
&lt;span&gt;搜狐&lt;/span&gt;
&lt;span&gt;新浪&lt;/span&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="标题标签-1" tabindex="-1"><a class="header-anchor" href="#标题标签-1" aria-hidden="true">#</a> 标题标签</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;h1&gt;一号&lt;/h1&gt;
&lt;h2&gt;二号&lt;/h2&gt;
&lt;h3&gt;三号/h3&gt;
&lt;h4&gt;四号&lt;/h4&gt;
&lt;h5&gt;五号&lt;/h5&gt;
&lt;h6&gt;六号&lt;/h6&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="段落标签-1" tabindex="-1"><a class="header-anchor" href="#段落标签-1" aria-hidden="true">#</a> 段落标签</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;p&gt;这是一个段落&lt;/p&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="换行标签-1" tabindex="-1"><a class="header-anchor" href="#换行标签-1" aria-hidden="true">#</a> 换行标签</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;br/&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><table><thead><tr><th style="text-align:center;">打开方式</th><th style="text-align:center;">属性值</th></tr></thead><tbody><tr><td style="text-align:center;">当前窗口打开</td><td style="text-align:center;">_self</td></tr><tr><td style="text-align:center;">新窗口打开</td><td style="text-align:center;">_blank</td></tr></tbody></table><figure><img src="`+i+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="列表标签" tabindex="-1"><a class="header-anchor" href="#列表标签" aria-hidden="true">#</a> 列表标签</h3><p><b style="color:#3e547d;"><strong>无序列表</strong></b></p><p>ul里面不能放任何标签</p><p>li里面能放别的标签</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;ul type=&quot;disc/circle/square&quot;&gt;
  &lt;li&gt;语文&lt;/li&gt;
  &lt;li&gt;数学&lt;/li&gt;
  &lt;li&gt;英语&lt;/li&gt;
  &lt;li&gt;计算机&lt;/li&gt;
...
tr   一行
td   一列
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>table常见属性 以下属性需要写到table标签中去</p><figure><img src="`+d+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="表单标签" tabindex="-1"><a class="header-anchor" href="#表单标签" aria-hidden="true">#</a> 表单标签</h3><p>使用表单目的是为了收集用户信息</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;form action=&quot;xxxx&quot; method=&quot;get/post&quot;&gt;
...
size:最多显示的行数
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,118),c=[u];function p(g,v){return e(),n("div",null,c)}const h=t(o,[["render",p],["__file","HTML.html.vue"]]);export{h as default};
