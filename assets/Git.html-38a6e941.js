import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as r,c as l,b as e,d as i,a as t,e as n}from"./app-f07825a0.js";const c={},v=n('<h1 id="git" tabindex="-1"><a class="header-anchor" href="#git" aria-hidden="true">#</a> Git</h1><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p>Git是一个免费的，开源的<strong>分布式</strong>版本控制系统，可以快速高效地处理从小型到大型的各种项目。创始人为Linux创始人Linux Torvalds。又称为版本控制是一种记录文件内容变化，以便将来查阅特定版本修订情况的系统。</p><h2 id="官网" tabindex="-1"><a class="header-anchor" href="#官网" aria-hidden="true">#</a> 官网</h2>',4),u={href:"https://git-scm.com/",target:"_blank",rel:"noopener noreferrer"},o=e("h2",{id:"下载",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#下载","aria-hidden":"true"},"#"),i(" 下载")],-1),m={href:"https://git-scm.com/",target:"_blank",rel:"noopener noreferrer"},g=n('<div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>下载完后一直下一步不建议修改安装目录，安装的目录路径不要有中文</strong></b></p></div><h2 id="作用" tabindex="-1"><a class="header-anchor" href="#作用" aria-hidden="true">#</a> 作用</h2><p>可以记录文件修改历史记录，从而让用户能够查看历史版本，方便版本切换。能让个人开发过度到团队协作。</p><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h2><p>下载完成后在某一文件夹下鼠标右键选择Open <strong>Git Bash</strong> Here会打开一个黑窗口，此窗口相当于一个小型的<strong>Linux环境</strong>，能输入Linux命令。</p><div class="hint-container warning"><p class="hint-container-title">注意</p><p><b style="color:#8f71e0;"><strong>第一次使用前必须要设置用户签名和邮箱，因为是多人环境，设置用户名和邮箱是为了方便区分。</strong></b></p></div><h3 id="git相关" tabindex="-1"><a class="header-anchor" href="#git相关" aria-hidden="true">#</a> Git相关</h3><div class="hint-container tip"><p class="hint-container-title">小贴士</p><p><b style="color:#A6522C;"> 以下命令中用[ ]括起来的内容表示自定义。如git add [FileName]表示FileName为自定义内容。可以为a.txt，也可为b.txt。</b></p></div><hr>',9),b=n(`<hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git config --global user.name [username]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,7),h=n(`<hr><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 命令：git commit -m &quot;[版本说明文字]&quot; 
...
先手动解决冲突
然后 git add .
然后 git commit -m &quot;[Version Description]&quot;
