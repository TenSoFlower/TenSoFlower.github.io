...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,46);function g(h,k){const s=l("ExternalLinkIcon");return c(),d("div",null,[o,n("p",null,[a("Git官网："),n("a",u,[a("https://git-scm.com/"),e(s)])]),v,n("p",null,[a("Git下载："),n("a",m,[a("https://git-scm.com/"),e(s)])]),b])}const N=t(r,[["render",g],["__file","Git.html.vue"]]);export{N as default};
