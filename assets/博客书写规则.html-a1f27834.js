import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as a}from"./app-6018dc01.js";const d={},l=a(`<h1 id="博客书写规则" tabindex="-1"><a class="header-anchor" href="#博客书写规则" aria-hidden="true">#</a> 博客书写规则</h1><h2 id="规则一-标题表示" tabindex="-1"><a class="header-anchor" href="#规则一-标题表示" aria-hidden="true">#</a> 规则一 标题表示</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 一级标题
## 二级标题
### 三级标题
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="规则五" tabindex="-1"><a class="header-anchor" href="#规则五" aria-hidden="true">#</a> 规则五 [ ]</h2><p>用[ ]括起来的内容表示可以自定义</p>`,28),s=[l];function t(r,c){return i(),n("div",null,s)}const o=e(d,[["render",t],["__file","博客书写规则.html.vue"]]);export{o as default};
