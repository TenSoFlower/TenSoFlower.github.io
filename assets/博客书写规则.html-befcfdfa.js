import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as a}from"./app-2e2af31c.js";const d={},l=a(`<h1 id="博客书写规则" tabindex="-1"><a class="header-anchor" href="#博客书写规则" aria-hidden="true">#</a> 博客书写规则</h1><h2 id="规则一-标题表示" tabindex="-1"><a class="header-anchor" href="#规则一-标题表示" aria-hidden="true">#</a> 规则一 标题表示</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 一级标题
## 二级标题
### 三级标题
...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="规则三-章节标题" tabindex="-1"><a class="header-anchor" href="#规则三-章节标题" aria-hidden="true">#</a> 规则三 章节标题</h2><p>如遇到按章节取标题</p><p>则章节和内容之间隔一个空格如下所示</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>第一章 科学边界
第二章 台球
第三章 射手和农场主
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="规则四-标点符号" tabindex="-1"><a class="header-anchor" href="#规则四-标点符号" aria-hidden="true">#</a> 规则四 标点符号</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>逗号：中文逗号，而不是,
句号：中文句号。而不是.
顿号：中文、用来分割多个并列如图片、链接、文字、声音、视频
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),s=[l];function t(r,c){return i(),n("div",null,s)}const o=e(d,[["render",t],["__file","博客书写规则.html.vue"]]);export{o as default};
